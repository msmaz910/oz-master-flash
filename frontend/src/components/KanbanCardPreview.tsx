...
export const KanbanCardPreview = ({ card, accent }: KanbanCardPreviewProps) => (
  <article className="relative rotate-1 rounded-2xl border border-[var(--stroke-strong)] bg-white px-4 py-3.5 shadow-[0_24px_44px_rgba(36,31,24,0.22)]">
    <span
      aria-hidden
      className="absolute left-0 top-4 bottom-4 w-[3px] rounded-full opacity-70"
      style={{ backgroundColor: accent ?? "#2f5d44" }}
    />
